defmodule ClubLAWeb.AdminUsersLive do
  @moduledoc """
  A live view to admin users on the platform (edit/suspend/delete).
  """
  use ClubLAWeb, :live_view
  alias ClubLA.{Accounts, Repo}
  alias ClubLA.Accounts.UserQuery
  alias ClubLAWeb.AdminUsersLive.UserFilterChangeset
  alias ClubLAWeb.UserAuth
  import ClubLAWeb.AdminLayoutComponent
