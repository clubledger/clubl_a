defmodule ClubLA.Accounts.UserNotifier do
  @moduledoc """
  When sending an email we use the functions in ClubLA.Email to generate the Email struct ready for Swoosh to send off.
