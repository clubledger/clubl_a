defmodule ClubLA.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, ClubLA.Repo)
  ...
  """
  def valid_password?(%ClubLA.Accounts.User{hashed_password: hashed_password}, password)
